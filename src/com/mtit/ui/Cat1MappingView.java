...
public class Cat1MappingView extends BaseView {
	...
	public Cat1MappingView(Composite parent) {
		super(parent);
		this.parent = parent;
	}
	...
	private void createButtons(Composite child) {
		...
		editButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				WizardDialog wizardDialog = new WizardDialog(parent.getShell(),
						new Cat1MappingWizard("EDIT", mapType));
		...
		printButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				gp.printTable(new TableWrapper(table), false, true, "Print Category1", composite.getShell());
		...
		refreshButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				try {
					...
					viewer.setInput(Category1MappingModelProvider.INSTANCE.refreshList());
					viewer.refresh();
	...
	protected void createViewer(Table table) {
		...
		viewer.setInput(Category1MappingModelProvider.INSTANCE
				.getTitleMappings());
	...
	private void createColumns(final TableViewer viewer) {
		String[] titles = { "MYOB Category 1", "Website Group",
				"Website Group ID", "Field Mapped To" };
		...
		col.setLabelProvider(new ColumnLabelProvider() {
			...
			public String getText(Object element) {
				...
				return (p.getMYOBCategory() == null) ? null : p
						.getMYOBCategory();
			}
		});
		...
		col.setLabelProvider(new ColumnLabelProvider() {
			...
			public String getText(Object element) {
				CategoryMappingType p = (CategoryMappingType) element;
				return p.getWebSiteCategoryID() == null ? null : p
						.getWebSiteCategoryID().toString();
			}
		});
		...
		new ColumnViewerSorter(viewer, col) {
			...
			protected int doCompare(Viewer viewer, Object e1, Object e2) {
				...
				String b1Id = b1.getWebSiteCategoryID() == null ? "" : b1
						.getWebSiteCategoryID().toString();
				String b2Id = b2.getWebSiteCategoryID() == null ? "" : b2
						.getWebSiteCategoryID().toString();
		...
		col.setLabelProvider(new ColumnLabelProvider() {
			@Override
			public String getText(Object element) {
				return WebWidgetsUtils.getWebsiteGroup("1");
			}
		});
	}
}
