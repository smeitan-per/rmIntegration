...
public class Cat2MappingView extends BaseView {
	...
	public Cat2MappingView(Composite parent) {
		super(parent);
		this.parent = parent;
	}
	...
	private void createButtons(Composite child) {
		...
		editButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				WizardDialog wizardDialog = new WizardDialog(parent.getShell(),
						new Cat2MappingWizard("EDIT", mapType));
		...
		printButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				gp.printTable(new TableWrapper(table), false, true, "Print Category2", composite.getShell());
		...
		refreshButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				try {
					...
					viewer.setInput(Category2MappingModelProvider.INSTANCE.refreshList());
					viewer.refresh();
	...
	protected void createViewer(Table table) {
		...
		viewer.setInput(Category2MappingModelProvider.INSTANCE.getTitleMappings());
	...
	private void createColumns(final TableViewer viewer) {
		String[] titles = { "MYOB Category 2", "Website Group", "Website Group ID",
				"Field Mapped To"};
		...
		col.setLabelProvider(new ColumnLabelProvider() {
			@Override
			public String getText(Object element) {
				return WebWidgetsUtils.getWebsiteGroup("2");
			}
		});
	}
